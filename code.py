...
conn=sql.connect(host='localhost',user='root',passwd='',da
 tabase='project) 
...
values(""'"+p_name+"',"+str(p_age)+",'"+p_problems+"',"+st
 r(p_phono)+")" 
...
values(""'"+d_name+"',"+str(d_age)+",'"+d_department+"',"+
 str(d_phono)+")" 
      c1.execute(sql_insert) 
      print('successfully registered') 
      conn.commit() 
...
values(""'"+w_name+"',"+str(w_age)+",'"+w_workname+"',"+st
 r(w_phono)+")" 
      c1.execute(sql_insert) 
      print('successfully registered') 
      conn.commit() 
